...
<div class="container">
    ...
    @include('swal')
    @include('dokumen.kontrak-tambang.create')
    @include('dokumen.kontrak-tambang.kirim-wa')
                ...
                <tr class="{{ $isDanger ? 'table-danger' : '' }}">
                    ...
                    <td class="text-center align-middle">
                        <div class="d-flex justify-content-center flex-wrap gap-3">
                            ...
                            <form action="{{ route('dokumen.kontrak-tambang.destroy', $d) }}" method="post" class="d-inline">
                                @csrf
                                @method('delete')
...
<script>
    function kirimWa(data) {
       ...
       document.getElementById('waForm').action = '/dokumen/kontrak-tambang/kirim-wa/'+data.id;
    }
