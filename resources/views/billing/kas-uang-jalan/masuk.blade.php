...
<div class="container">
    <div class="row justify-content-center mb-5">
        <div class="col-md-12 text-center">
            <h1><u>Kas Uang Jalan (Masuk)</u></h1>
        </div>
    </div>
    @if (session('error'))
        <script>
    ...
    @endif
    <form action="{{route('kas-uang-jalan.masuk.store')}}" method="post" id="masukForm">
        @csrf
        <div class="row">
            <div class="col-md-2 mb-3">
                <label for="kode" class="form-label">Kode</label>
                <div class="input-group mb-3">
                    <span class="input-group-text" id="basic-addon1">KUJ</span>
            ...
            <div class="col-md-4 mb-3">
                ...
                <div class="input-group mb-3">
                    ...
                    is-invalid
                @endif" name="nominal_transaksi" id="nominal_transaksi" required data-thousands="." value="30.000.000">
                  </div>
